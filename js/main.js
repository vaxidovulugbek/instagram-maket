...
let insta = [
  ...
  },
  {
    ...
    media:[
      ...
      "https://arkansasrazorbacks.com/wp-content/uploads/2020/10/College-Football-Ole-Miss-at-Arkansas-5_57_11-PM-5_57_25-PM-2020-10-17-1.mp4?_=14",
...
let idxx = 1
let idbtn = 1
let modaladd = document.querySelector("#modaladding")
...
elmodalinfobtn.forEach((el) => {
  el.addEventListener("click",(e) => {
    e.preventDefault()
    if (bookmCount % 2 == 0) {
      el.innerHTML = `<i class='bx bxs-bookmark' ></i>`
    }
    else {
      el.innerHTML = `<i class='bx bx-bookmark'></i>`
    }
    bookmCount++
          ...
          <div class="modal-info">
            ...
            <div class="modal-info-foter">
              <div class="modal-footerr">
                ...
                <div  class="modal-info-likes"><span id="modal-info-like" class="me-2 btn-sum">342</span><p class="m-0">"Likes"</p></div>
                <p class="modal-day-text">one day ego</p>
              </div>
              <div class="modal-send-message">
                <div>
          ...
          <div class="modal-info">
            ...
            <div class="modal-info-foter">
              <div class="modal-footerr">
                ...
                <div class="modal-info-likes"><span id="modal-info-like" class="me-2 btn-sum">${item.like}</span><p class="m-0">"Likes"</p></div>
                <p class="modal-day-text">one day ego</p>
              </div>
              <div class="modal-send-message">
                <div>
...
let modalinfobuttom = document.querySelectorAll(".modal-info-buttom")
let elspansum = document.querySelectorAll(".btn-sum")
let count5 = 0
let sum = 1


modalinfobuttom.forEach((item) => {
    item.addEventListener("click", () => {
      if (count5 % 2 == 0) {
        item.innerHTML = `<i class='bx bxs-heart'></i>`
        ...
        item.innerHTML = `<i class='bx bx-heart' ></i>`
        elspansum.forEach(element => {
...
// element.classList.toggle("doubeclick");
...
//     if (hisob == 2) {
//       hisob -= 1
//       el.classList.add("doubeclick")
//       console.log("lll");
//     }
//     // else if (hisob == 1) {
//     //   el.classList.remove("doubeclick")
//     //   hisob++
//     // }
//   })
// }
