          ...
          <div class="modal-content">
            <div class="modal-body">
              <div class="fathermodal-img">
                <img class="modal-img" src="${el.media[0]}" alt=""> 
              </div> 
                ...
                <div class="modal-info-foter">
                  <div class="modal-footerr">
                    <div class="modal-info-fc">
                      ...
                      <button id="1" class="modal-info-btns cl-modal-info-btn">
...
// insta.forEach((el,) => {
// modaladd.innerHTML = `
// <div class="modal fade" id="exampleModal${idxxlar}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
// <div class="modal-dialog">
//   <div class="modal-content">
//     <div class="modal-body">
//       <div class="fathermodal-img">
...
let elclmodalinfobtn = document.querySelectorAll(".cl-modal-info-btn")

let count3 = 0

elclmodalinfobtn.forEach((item2 ,index) => {
      ...
      if (item.save == true) {
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-body">
              <div class="fathermodal-img">
                <img class="modal-img" src="${item.media}" alt="">
              </div>
              <div class="modal-info">
                <div class="modal-info-el">
                  <div class="modal-info-cont">
                ...
                <div class="modal-info-foter">
                  <div class="modal-footerr">
                    <div class="modal-info-fc">
                      ...
                      <button id="modal-info-btn" class="modal-info-btns cl-modal-info-btn">
